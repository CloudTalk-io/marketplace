...
expect_error("quoted defaultOutboundNumberId", lambda c: c.__setitem__("defaultOutboundNumberId", "101"), "bad-type")
expect_error("quoted failoverOutboundNumberId", lambda c: (c.__setitem__("defaultOutboundNumberId", 1), c.__setitem__("failoverOutboundNumberId", "202")), "bad-type")
